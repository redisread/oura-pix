...
export async function signIn(
  ...
  try {
    ...
    return {
      success: false,
      error: err.response?.data?.error?.message || "Sign in failed",
    };
  }
}
...
export async function signUp(
  ...
  try {
    ...
    return {
      success: false,
      error: err.response?.data?.error?.message || "Sign up failed",
    };
  }
}
...
export async function requestPasswordReset(
  ...
  try {
    ...
    return {
      success: false,
      error: err.response?.data?.error?.message || "Password reset failed",
    };
  }
}
